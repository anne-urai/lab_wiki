...
- Knowing how long to keep trying something, and when to **ask for help**, is a tremendously useful skill. 
    - A useful guideline: if you know what next steps to take (keywords to Google, instructions to follow, control analyses to run) then take them first. If you can no longer identify how to move forward, don't waste time being stuck and ask for help or advice.
...
- Organize your work, and practice good **project and time management**.
    ...
    - See the specific setup for project management under _Getting started_.

## Expectations for PhD students
- Be present in the lab during regular hours. I generally encourage you to work during regular office hours. However, apart from times of e.g. data collection or deadlines, the flexibility of science is one of its main perks: take advantage of this, and find out what schedule works best for you.
...
- Finish what you started: as your project matures, you will increasingly be in charge of your own goals and the steps necessary to meet them. 
...
- all of the above, _and_:
- Actively look out for grants that you may to apply for.
- Help shape lab culture and give Anne feedback on mentoring and leadership.
- Mentor students in the lab ([this internal document](https://leidenuniv1.sharepoint.com/:w:/r/sites/ACPprojectoncircadianrhythms/_layouts/15/Doc2.aspx?action=edit&sourcedoc=%7B03dc7b02-aedc-47d3-9676-f5e3bc060596%7D&wdOrigin=TEAMS-MAGLEV.teamsSdk_ns.rwc&wdExp=TEAMS-TREATMENT&wdhostclicktime=1762953802247&web=1) provides starting points for mentoring).
...
## Mentoring up - further resources
I encourage lab members (especially postdocs) to practice their own mentoring skills. [This internal document](https://leidenuniv1.sharepoint.com/:w:/r/sites/ACPprojectoncircadianrhythms/_layouts/15/Doc2.aspx?action=edit&sourcedoc=%7B03dc7b02-aedc-47d3-9676-f5e3bc060596%7D&wdOrigin=TEAMS-MAGLEV.teamsSdk_ns.rwc&wdExp=TEAMS-TREATMENT&wdhostclicktime=1762953802247&web=1) provides starting points for mentoring.
