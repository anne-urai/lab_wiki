...
- Mary Oliver's poetry (one of my favorite ones is [here](https://thedewdrop.org/2019/07/03/mary-oliver-teach-the-children/))
- The nutmeg's curse by Amitav Ghosh (and his other books)

### On hope in dark times
- Active Hope, by Joanna Macy (and her many other books; [powerful short talk](https://www.youtube.com/watch?v=vzmjF1jE2K0); **do an _Active hope_ or _Work that reconnects_ workshop/session**)
- I want a better catastrophe, by Andrew Boyd (accompanying [flowchart](https://flowchart.bettercatastrophe.com/))
- Not too late, by Rebecca Solnit (accompanying [website](https://www.nottoolateclimate.com/); anything written by Solnit is gold)
