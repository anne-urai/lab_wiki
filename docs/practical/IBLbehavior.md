...
---
layout: default
title: Working with IBL behavioral data
...
{: .warning }
This information relies on IBL-datajoint integration, which has been deprecated. However, the exercises below may still be useful to get familar with basic IBL behavioral data.
