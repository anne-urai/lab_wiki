...
- Be present in the lab during regular hours, at least a few days a week (for postdocs and PhD students). I generally encourage you to work during regular office hours, and to be present for departmental events to benefit from the social and scientific interactions. However, apart from times of e.g. data collection or deadlines, the flexibility of science is one of its main perks: take advantage of this, and find out what schedule works best for you.
    ...
    - Inform Anne about absences (sickness, vacation, conferences, etc).
...
### Meetings
Please join the [weekly CogPsy meetin](https://anne-urai.github.io/lab_wiki/Practical.html) and lab meeting (coming in Fall 2022). For new projects, I normally start with **meetings on demand**: when you either get stuck or have something to show me (one of these should happen every few weeks), book a meeting through Calendly and send me a short description beforehand. However, every person is different and some projects may benefit from regular meetings (e.g. once a week, once every two weeks). Talk to me and find out what works for you.